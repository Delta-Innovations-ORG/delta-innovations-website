...
| **Couldn't fetch**, Last read **empty** | Google never got a response (protection, timeout, or submitted before deploy finished) | Wait for Vercel **Ready**, run `npm run verify:seo`, delete + resubmit in GSC |
